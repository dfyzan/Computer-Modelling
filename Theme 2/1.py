...
def vector_input():
    x, y = map(float, input("Введите две координаты вектора: ").split())
    v = [x, y] 
    return v
...
print(f"Угол между векторами 1 и 3 равен: {ang(v1, v3)} радиан или {math.degrees(ang(v1, v3))} градусов.")
print(f"Угол между векторами 2 и 3 равен: {ang(v2, v3)} радиан или {math.degrees(ang(v2, v3))} градусов.")
...
if (par(v1, v2)): print("Вектора 1 и 2 парралельны.")
if (par(v1, v3)): print("Вектора 1 и 3 парралельны.")
if (par(v3, v2)): print("Вектора 2 и 3 парралельны.")